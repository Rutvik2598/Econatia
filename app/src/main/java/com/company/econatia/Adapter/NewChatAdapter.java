...
public class NewChatAdapter extends RecyclerView.Adapter<NewChatAdapter.ViewHolder> {
    ...
    public NewChatAdapter(Context mContext, List<User> mUsers, boolean isfragment) {
    ...
    @NonNull
    @Override
    public NewChatAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.user_item , viewGroup , false);
        return new NewChatAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final NewChatAdapter.ViewHolder viewHolder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public RelativeLayout newChatRL;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            newChatRL = itemView.findViewById(R.id.newChatRL);
